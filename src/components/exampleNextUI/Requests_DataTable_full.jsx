...
// import { PlusIcon } from "../Forms/PlusIcon";
import { VerticalDotsIcon } from "../Forms/VerticalDotsIcon";
import { SearchIcon } from "../Forms/SearchIcon";
import { ChevronDownIcon } from "../Forms/ChevronDownIcon";
...
export default function UseCaseTable() {
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (hasSearchFilter) {
      filteredRequests = filteredResquests.filter((user) =>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between gap-3 items-end">
          <Input
            ...
            placeholder="Search by request text..."
